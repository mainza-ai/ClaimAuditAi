...
const ACTIVE_CHIP_STYLES: Record<
  string,
  { color: string; borderColor: string; backgroundColor: string; boxShadow: string }
> = {
  all: {
  ...
  critical: {
    ...
    boxShadow: '0 0 12px var(--color-danger-bg)',
  },
  high: {
    color: 'var(--color-warning)',
    borderColor: 'var(--color-warning-border)',
    backgroundColor: 'var(--color-warning-bg)',
    boxShadow: '0 0 12px var(--color-warning-bg)',
  },
  medium: {
    color: 'var(--color-success)',
    borderColor: 'var(--color-success-border)',
    backgroundColor: 'var(--color-success-bg)',
    boxShadow: '0 0 12px var(--color-success-bg)',
  },
};
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            ...
            >
              <option value="risk" style={{ backgroundColor: 'var(--bg-card)' }}>
                Sort by risk
              </option>
              <option value="date" style={{ backgroundColor: 'var(--bg-card)' }}>
                Sort by date
              </option>
              <option value="amount" style={{ backgroundColor: 'var(--bg-card)' }}>
                Sort by amount
              </option>
            </select>
            <ArrowUpDown
      ...
      <div className="space-y-2.5">
        ...
        {isLoading && (
          <div className="text-sm text-center py-16" style={{ color: 'var(--text-secondary)' }}>
            Loading pended claims...
          </div>
        )}
        {paginated?.map((claim) => (
