  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        ...
        <span style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-primary)' }}>ClaimAuditAI Adjudicator</span>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {PERMISSIONS.canManageData(activeRole) && (
          <button
            ...
            aria-label={
              seed.isPending ? 'Seeding sample data...' : seedDone ? 'Sample data seeded' : 'Seed sample data'
            }
            style={{
              display: 'flex',
              alignItems: 'center',
