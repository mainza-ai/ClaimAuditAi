...
const HoldQueue = lazy(() => import('./views/HoldQueue'));
const ClaimDetail = lazy(() => import('./views/ClaimDetail'));
const GraphView = lazy(() => import('./views/GraphView'));
const Ledger = lazy(() => import('./views/Ledger'));
const LLMSettings = lazy(() => import('./views/LLMSettings'));
const DataManagement = lazy(() => import('./views/DataManagement'));
const LoginPage = lazy(() => import('./views/LoginPage'));
const AuditAssistant = lazy(() => import('./components/assistant/AuditAssistant'));
