...
| :--- | :--- | :--- | :--- |
| `POST` | `/interop/fhir/r4` | `Bundle` (Transaction) | Bulk-ingests patient records, progress notes, or claims. |
...
## Key Details
- **Root URL**: `http://localhost:52773/interop/fhir/r4` (or port `8080` depending on container routing)
